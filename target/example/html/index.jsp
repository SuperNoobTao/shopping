...
<section class="flash" id="flash">
        ...
        <ul class="flashImg">
            <li><a href="/${flashdetail0.productid}"><img src="${flashdetail0.bigimgurl}" /><span></span></a></li>
            <li style="display:none;"><a href="/${flashdetail1.productid}"><img src="${flashdetail1.bigimgurl}" /><span></span></a></li>
            <li style="display:none;"><a href="/${flashdetail2.productid}"><img src="${flashdetail2.bigimgurl}" /><span></span></a></li>
        </ul>
